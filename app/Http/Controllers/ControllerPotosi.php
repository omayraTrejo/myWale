...
class ControllerPotosi extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            $potosi=DB::table('votosdespartamentales as vo')
            ...
            ->where('vo.departamento','=','POTOSI')
            ->orderBy('vo.idvotosdespartamentales','desc')
            ->paginate(7);
            return view('departamento.POTOSI.index',["potosi"=>$potosi,"searchText"=>$query]);
        }
    }
