...
class ControllerTarija extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            $tarija=DB::table('votosdespartamentales as vo')
            ...
            ->where('vo.departamento','=','TARIJA')
            ->orderBy('vo.idvotosdespartamentales','desc')
            ->paginate(7);
            return view('departamento.TARIJA.index',["tarija"=>$tarija,"searchText"=>$query]);
        }
    }
