...
class ControllerBeni extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            $beniControl=DB::table('votosdespartamentales as vo')
            ...
            ->where('vo.departamento','=','BENI')
            ->orderBy('vo.idvotosdespartamentales','desc')
            ->paginate(7);
            return view('departamento.BENI.index',["beniControl"=>$beniControl,"searchText"=>$query]);
        }
    }
