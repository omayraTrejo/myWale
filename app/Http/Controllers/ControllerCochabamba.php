...
class ControllerCochabamba extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            $cochabamba=DB::table('votosdespartamentales as vo')
            ...
            ->where('vo.departamento','=','COCHABAMBA')
            ->orderBy('vo.idvotosdespartamentales','desc')
            ->paginate(7);
            return view('departamento.COCHABAMBA.index',["cochabamba"=>$cochabamba,"searchText"=>$query]);
        }
    }
